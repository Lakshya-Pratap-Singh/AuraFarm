...
if (!getApps().length) {
  ...
  if (!serviceAccountJson) {
    // Fail loud at boot rather than a confusing 401 on the first request —
    // this is a required env var, not an optional one, once this file is live.
    throw new Error(
      "FIREBASE_SERVICE_ACCOUNT_JSON is not set. See migration-notes.md §5."
    );
  }
