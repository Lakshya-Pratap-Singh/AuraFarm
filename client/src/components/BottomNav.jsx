...
const icons = {
  ...
  profile: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
      ...
      <path d="M6 17c0.5-2.2 1.8-3.4 3-3.4s2.5 1.2 3 3.4" strokeLinecap="round" />
      <line x1="14" y1="9" x2="18" y2="9" strokeLinecap="round" />
      <line x1="14" y1="12" x2="18" y2="12" strokeLinecap="round" />
    </svg>
  ),
  gear: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
...
function BottomNav({ activeNav, onNavChange }) {
  ...
  const moreIsActive = moreOpen || ["Relics", "Profile", "Settings"].includes(activeNav);
